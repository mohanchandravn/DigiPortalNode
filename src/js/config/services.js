...
define(['knockout', 'config/serviceConfig' 
    ...
    function services() {
        ...
        self.uploadDocument = function (document, companyName, invoiceNumber, invoiceDate) {
            var serviceURL = self.portalRestHost() + "/docs/upload/uploadFile?companyName=" + companyName + "&invoiceNumber=" + invoiceNumber + "&invoiceDate=" + invoiceDate;
        ...
        self.downloadDocument = function (fileId, version) {
            var serviceURL = self.portalRestHost() + "/docs/download/downloadDocument?fileId=" + fileId + '&version=' + version;
            serviceConfig.downloadFile(serviceURL);
        };
